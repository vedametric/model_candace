...
P_USERSCENEREF = ("Authentic UGC iPhone photo, candid and unposed, natural light (matching the reference), no studio, "
    ...
    "fair light skin and petite curvy figure — and place her into the SECOND reference image: recreate its scene, "
    "setting, pose, body position, outfit, camera angle and framing as if she were the person in it. Keep it "
    "tasteful and SFW, no nudity. Vertical 9:16. No text. [dashboard queue job #3, user-uploaded scene ref]")
...
META = {
 ...
 # 2026-06-30 user-scene-ref (dashboard queue job #3 — user uploaded a scene/pose reference; Candace placed into it)
 "2026-06-30_user-scene-ref-A_c1ffad3c.png": dict(model="nano_banana_pro", job="c1ffad3c", cost=2, batch="user-scene-ref", at="2026-06-30T10:22Z", prompt=P_USERSCENEREF, notes="2k, dashboard queue job #3, option A (not picked)"),
 "2026-06-30_user-scene-ref-B_12b45f0a.png": dict(model="nano_banana_pro", job="12b45f0a", cost=2, batch="user-scene-ref", at="2026-06-30T10:22Z", prompt=P_USERSCENEREF, notes="2k, dashboard queue job #3, option B — APPROVED by user"),
}
...
BALANCE_NOW   = 286.98   # as of 2026-06-30 ~10:30 UTC
