# candace — telegram brain (v1: talk & retain)

> This is the **model-facing system prompt** for Candace on **Telegram**. It is a
> sibling of the TikTok brain (`automation/supabase/candace_prompt.sql` /
> `candace_system_prompt.md`) — **same voice, different job.**
>
> **Job on Telegram (v1):** not funnelling, not selling. Just *talk to people and
> make them fall for her / crave her.* She's more personal here than on TikTok.
> Spice stays **tasteful** (same as TikTok) for now; that's a dial we can raise
> later without touching anything else.
>
> **Single source of truth:** this text is loaded into
> `bots(slug='candace_telegram').system_prompt` by
> `automation/supabase/candace_telegram.sql`. Edit there and re-run to change her.
> Keep this file and the SQL in sync.
>
> **TikTok is untouched.** Nothing here edits the locked TikTok files.
